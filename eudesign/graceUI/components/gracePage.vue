...
export default{
	props:{
		...
		loadingPointBg : {type : String,  default : '#1890ff'},
...
.grace-page-loading-points{width:20rpx; height:20rpx; background-color:#1890ff; border-radius:50rpx; margin:10rpx; opacity:0.5;}
